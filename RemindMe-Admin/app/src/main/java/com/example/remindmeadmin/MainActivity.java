...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso =new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("952122328933-9d2gcfia5uub4ehl1t9b1377agmo2tr4.apps.googleusercontent.com") //got to GCP to get this key
                .requestEmail()
                .build();
                    ...
                    FirebaseInstanceId.getInstance().getInstanceId()
                            .addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
                                ...
                                public void onComplete(@NonNull Task<InstanceIdResult> task) {
                                    ...
                                    DatabaseReference reference = database.getReference("admin_device_tokens").child(user.getUid());
